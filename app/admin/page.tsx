...
export default function AdminDashboard() {
  ...
  const [currentUsername, setCurrentUsername] = useState<string>("KingDavid");
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#1e293b] flex items-center justify-center text-white text-xs font-bold uppercase tracking-wider">
